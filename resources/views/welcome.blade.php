       ...
       <div class="row">
          <div class="col-md-12">
             <div class="main-title">
                ...
                <h6>{{ GoogleTranslate::trans('Featured Videos', app()->getLocale()) }}</h6>
             </div>
          </div>


          @if ($videos instanceof \Illuminate\Pagination\LengthAwarePaginator)
          {{-- Wenn paginierte Daten vorhanden sind --}}
          @foreach ($videos as $video)
              {{-- Zeige die Videos hier an --}}

              <div class="col-xl-3 col-sm-6 mb-3">
                <div class="video-card">
                    <div class="video-card-image">
                        <a class="play-icon" href="{{ route('watch.video', $video)}}"><i class="fas fa-play-circle"></i></a>
                        <a href="#"><img class="img-fluid" src="{{ asset($video->thumbnail) }}" alt=""></a>
          ...
          {{-- Zeige die Pagination-Links an --}}
       <div>
          {{ $videos->links() }}
         </div>

      @else
          {{-- Wenn keine Pagination --}}
          @foreach ($videos as $video)
              {{-- Zeige die Videos hier an --}}
              <div class="col-xl-3 col-sm-6 mb-3">
                <div class="video-card">
