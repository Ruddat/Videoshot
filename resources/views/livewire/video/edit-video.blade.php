<div class="container-fluid upload-details" wire:poll.visible>
    <div class="row">
       <div class="col-lg-12">
       ...
       <div class="col-lg-2">
        ...
        <img src="@videoThumbnail($video->thumbnail_image)" alt="{{ $video->title }}" class="img-fluid rounded-4">
    @else
        <img src="{{ asset('img/v1.png') }}" alt="{{ $video->title }}" class="img-fluid rounded-4">
    @endif

       </div>
       <div class="col-lg-10">
          <div class="osahan-title">{{ $video->title }}</div>
          <div class="osahan-size">102.6 MB . 2:13 MIN Remaining</div>
          <div class="osahan-progress">
             <div class="progress">
                <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="{{ $this->video->processing_percentage }}"   aria-valuemin="0" aria-valuemax="100" style="width: {{ $this->video->processing_percentage }}%"></div>
             </div>
             <div class="osahan-close">
                <a href="#"><i class="fas fa-times-circle"></i></a>
             </div>
          </div>
          <div class="osahan-desc">Your Video is still processing, please keep this page open until it's done.</div>
       </div>
    </div>
    <hr>
